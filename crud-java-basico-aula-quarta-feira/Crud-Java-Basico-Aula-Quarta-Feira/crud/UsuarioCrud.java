...
public class UsuarioCrud extends javax.swing.JFrame {
    ...
    private void tbnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnSalvarActionPerformed
        ...
        if ((txtNome.getText().isEmpty()) || (txtCPF.getText().isEmpty()) || (txtEmail.getText().isEmpty()) || (txtTelefone.getText().isEmpty())) {
            ...
            // instanciando a classe Usuario do pacote dados e criando seu objeto dados
            objDAO = new UsuarioDados();
    ...
    private void tbnExit1ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            UsuarioDados.testarConexao();
